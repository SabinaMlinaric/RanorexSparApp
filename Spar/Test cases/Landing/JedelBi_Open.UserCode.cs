...
{
	public partial class JedelBi_Open
	{
		/// <summary>
		...
		public void OpenJedelBi()
		{
			...
			while(tryNum < 6 && !exists){
				...
				repo.PlusSparSi.MainActivity.ImgJedelBiInfo.SearchTimeout = new Duration(1000);
				
				exists = repo.PlusSparSi.MainActivity.ImgJedelBiInfo.Exists();
			...
			if(exists){
				...
				repo.PlusSparSi.MainActivity.ImgJedelBi.Touch();
				Delay.Milliseconds(500);
			}
		}
	}
