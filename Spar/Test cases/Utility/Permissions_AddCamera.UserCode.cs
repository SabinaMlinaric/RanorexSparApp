...
{
    public partial class Permissions_AddCamera
    {
        /// <summary>
        ...
        public void AddCameraPermission()
        {
			...
			adbClearProcess.StartInfo.Arguments = string.Format("shell pm grant {0} android.permission.CAMERA", appPackageName);
