...
{
    public partial class Permissions_DenyLocationAccess
    {
        /// <summary>
        ...
        public void DenyLocationPermission()
        {
			...
			adbClearProcess.StartInfo.Arguments = string.Format("shell pm revoke {0} android.permission.ACCESS_FINE_LOCATION", appPackageName);
