...
{
    public partial class Permissions_AddLocation
    {
        /// <summary>
        ...
        public void AddLocationPermission()
        {
			...
			adbClearProcess.StartInfo.Arguments = string.Format("shell pm grant {0} android.permission.ACCESS_FINE_LOCATION", appPackageName);
