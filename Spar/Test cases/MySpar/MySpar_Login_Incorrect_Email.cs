...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The MySpar_Login_Incorrect_Email recording.
    /// </summary>
    [TestModule("d979cbce-c85f-433c-b25e-8c722b4a9e35", ModuleType.Recording, 1)]
    public partial class MySpar_Login_Incorrect_Email : ITestModule
    {
        /// <summary>
        ...
        static MySpar_Login_Incorrect_Email instance = new MySpar_Login_Incorrect_Email();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public MySpar_Login_Incorrect_Email()
        {
        }
        ...
        /// </summary>
        public static MySpar_Login_Incorrect_Email Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set Value", "Setting attribute Text to 'test@mail.com' on item 'PlusSparSi.LoginSignInActivity.InputEnterEmail'.", repo.PlusSparSi.LoginSignInActivity.InputEnterEmailInfo, new RecordItemIndex(6));
            repo.PlusSparSi.LoginSignInActivity.InputEnterEmail.Element.SetAttributeValue("Text", "test@mail.com");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set Value", "Setting attribute Text to 'Adgjadgj1' on item 'PlusSparSi.LoginSignInActivity.InputPassword'.", repo.PlusSparSi.LoginSignInActivity.InputPasswordInfo, new RecordItemIndex(7));
