...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The MySpar_Login_TooShortSN recording.
    /// </summary>
    [TestModule("5d7e1ee9-7abb-493c-86ae-93fb8cc19c1b", ModuleType.Recording, 1)]
    public partial class MySpar_Login_TooShortSN : ITestModule
    {
        /// <summary>
        ...
        static MySpar_Login_TooShortSN instance = new MySpar_Login_TooShortSN();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public MySpar_Login_TooShortSN()
        {
        }
        ...
        /// </summary>
        public static MySpar_Login_TooShortSN Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set Value", "Setting attribute Text to '0101010' on item 'PlusSparSi.EnterNumberActivity.EtCardNumber'.", repo.PlusSparSi.EnterNumberActivity.EtCardNumberInfo, new RecordItemIndex(3));
            repo.PlusSparSi.EnterNumberActivity.EtCardNumber.Element.SetAttributeValue("Text", "0101010");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Enabled='False') on item 'PlusSparSi.EnterNumberActivity.BtnNext'.", repo.PlusSparSi.EnterNumberActivity.BtnNextInfo, new RecordItemIndex(4));
